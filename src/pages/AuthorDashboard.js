...
const AuthorDashboard = () => {
  ...
  const [loading, setLoading] = useState(true);
    const navigate = useNavigate(); // 👈 Initialize the hookF
  ...
  return (
    <div className="min-h-screen bg-academic-50">
        ...
        <div className="mb-10 grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-100 shadow-sm">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-xl font-bold text-slate-900 mb-2">Author Guidelines</h3>
                <p className="text-slate-700 mb-4 max-w-md">
                  Formatting, structure, submission requirements, and ethical policies.
                </p>
                <a
          ...
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-100 shadow-sm">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-xl font-bold text-slate-900 mb-2">Download Resources</h3>
                <p className="text-slate-700 mb-4 max-w-md">
                  Official templates and forms for submission.
                </p>
      ...
      <div className="mb-10">
    <button
      onClick={() => navigate('/submitform')} // 👈 Use the hook
